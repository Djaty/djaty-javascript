    ...
    _loadCoreLib(loadAfterCoreLoad) {
      ...
      function onLoadError(err, msg) {
        ...
        const errMsg = msg || `Refused to connect to Djaty. It is most likely a Content Security \
          Policy (CSP) or a connectivity problem. To solve this issue see <a target="_blank" href="${Djaty.config.apiUrl}/docs/SDKs/frontendJs/troubleshooting.html#use-djaty-javascript-sdk-with-a-content-security-policy">Troubleshooting</a>`;
      ...
      try {
        ...
        if (err.message.indexOf('Content Security Policy') !== -1) {
          onLoadError(`${err.name}: Refused to connect to Djaty. It is most likely a Content Security \
            Policy (CSP) or a connectivity problem. To solve this issue see \
            <a target="_blank" href="${Djaty.config.apiUrl}/docs/SDKs/frontendJs/troubleshooting.html#use-djaty-javascript-sdk-with-a-content-security-policy">Troubleshooting</a>`);
